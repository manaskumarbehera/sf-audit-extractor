// filepath: /Users/manas/IdeaProjects/sf-audit-extractor/src/soql/soql_suggestions_engine.js
...
async function buildDescribeFromProvider(describeProvider, objectApiName) {
  ...
  // Accept the compatibility shim: caller may pass an array of fields directly
  if (Array.isArray(describeProvider)) return { fields: describeProvider, parentFields: {} };
