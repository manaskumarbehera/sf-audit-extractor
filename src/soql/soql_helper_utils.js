// filepath: /Users/manas/IdeaProjects/sf-audit-extractor/src/soql/soql_helper_utils.js
...
export function getWherePhase(txt, pos) {
  ...
  if (/\b(=|!=|<=|>=|<|>|LIKE|NOT\s+LIKE|IN|NOT\s+IN|INCLUDES|EXCLUDES)\s*$/.test(tail)) return 'VALUE';
